    ...
    <table class="table">
        <tbody>
            <tr v-for="item in data.powerfox">
                <td>
                    <div class="card">
                        <div class="card-header"><a @click="openDataPF(item.powerfox.id)"
                                style="text-decoration: underline;">{{
                                    item.powerfox.name }} | {{ formatDate(item.data.timestamp) }}</a>
                        </div>
                        <div class="card-body">
                            {{ item.data.watt }}
                        </div>
                ...
                <td>
                    <div class="card">
                        <div class="card-header"><a @click="openData(item.device.id)" style="text-decoration: underline;">{{
                            item.device.name }} | {{ formatDate(item.data.received_at) }}</a>
                        </div>
                        <div class="card-body">
                            <ul>
